...
total_test_records = X_test.shape[0]

test_record = random_test_record(total_test_records)

print(f"Testing for {test_record}th record of the Test set")
...
def main() -> dict:
    ...
    test_txn = X_test.iloc[test_record].to_frame().T
